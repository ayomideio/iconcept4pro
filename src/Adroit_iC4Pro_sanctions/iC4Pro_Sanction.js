...
import langData from '../Data/tempData/ic4pro_language.json';
            ...
            <Row >
              ...
              <Col style={{ padding: '0' }}>
                <button type="submit"
                  ...
                  style={{ fontSize: "11px", background: "#66BB6A", color: "white", border: 'none', borderRadius: '2px' }}>
...
export default Adroit_IC4Pro_Language;
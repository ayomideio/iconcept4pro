...
import SanctionHistoryDetails from './sanctionHistoryDetails';
...
const FormContainer = ({
  ...
  const onSubmit = data => {
    const newData = {
      ...
      ic4proLanugageName: data.ic4proLanguageName,
    ...
    >
      ...
      >
        ...
        <Modal.Header closeButton={false} style={{backgroundColor:"#2196F3", padding:"0 0", color: '#EEF8F0'}}>
              ...
              View Language History </Modal.Title>
            <Row>

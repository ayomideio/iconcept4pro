    ...
    return (
        <div className="layout-topbar">
            <button className="layout-topbar-logo p-link" onClick={() => history.push('/')}>
                <img id="layout-topbar-logo" src="assets/layout/images/logo-white.png" alt="iConcept4-layout" />
            </button>
            ...
            <ul className={topbarMenuClassName}>
                    ...
                    isProfilePopup && (
                        <li className={profileItemClassName}>
                            <button className="p-link" onClick={(e) => props.onTopbarItemClick(e, 'profile')}>
                                <img alt="iConcept4-layout" src="assets/layout/images/avatar.png" />
                ...
                <button type="button" 
                className=" p-link" onClick={onConfigButtonClick}>

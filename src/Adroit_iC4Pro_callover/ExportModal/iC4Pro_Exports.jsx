...
function App(props) {
    ...
    const columns = React.useMemo(
        () => [
            {
                Header: 'Branch Code',
                accessor: 'IC4_BRANCH_CODE',
                aggregate: 'count',
                Aggregated: ({ value }) => `${value} Total`,
            },
            {
                Header: 'Entry Date',
                accessor: 'GRP_BY_DATE',
                aggregate: 'count',
                Aggregated: ({ value }) => `${value} Total`,
            },
            {
            ...
            {
                Header: 'Credit Freq',
                accessor: 'NO_OF_CREDIT',
                aggregate: 'count',
                Aggregated: ({ value }) => `${value} Total`,
            },
            {
                Header: 'Total Credit',
                accessor: 'CREDIT_TOTAL_CALL',
                aggregate: 'count',
                Aggregated: ({ value }) => `${value} Total`,
            },
            {
                Header: 'Debit Freq',
                accessor: 'NO_OF_DEBIT',
                aggregate: 'count',
                Aggregated: ({ value }) => `${value} Total`,
            },
            {
                Header: 'Total Debit',
                accessor: 'DEBIT_TOTAL_CALL',
                aggregate: 'count',
                Aggregated: ({ value }) => `${value} Total`,
            }
        ],
    ...
    const data = React.useMemo(() => processData(props.dataset), []);

...
import dataset from '../../Data/tempData/ic4pro_regulatorData.json';
import ExportDistributionData from '../ExportModal/iC4Pro_ExportsDistribution';
...
`
  ...
  const handleExportClose = () => setExportData(false);
  ...
  function Legend() {
    ...
    return (
      <div>
        ...
        <Dialog
        header={<span style={{padding:'10px', background:'lightgray'}}>Regulator Export</span>}
        visible={exportData}

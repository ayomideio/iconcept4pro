...
import fainsHisData from '../Data/ic4pro_fains_his.json';
...
<Card style={{border: "none"}}>
        ...
        {/* <div style={{background:"#F8A316", width:"8.2rem", height:'50px', marginLeft:'7.5rem'}} >
        ...
        <div style={{background:"#F8A316", width:"8.3rem", height:'50px', marginLeft:'0.6rem'}}>
				<Row style={{marginLeft: "0.3rem"}}>

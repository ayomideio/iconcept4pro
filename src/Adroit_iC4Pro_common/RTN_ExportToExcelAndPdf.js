...
function ExportPdf(id) {
    ...
    savePDF(document.getElementById(id), { paperSize: 'A2', landscape: true, fileName: "List -"+moment().format('YYYYMMDD-HHmm') });
...
function ExportExcel(props) {
    ...
    return <div>
        <ExcelFile element={button} filename={"List -" + moment().format('YYYYMMDD-HHmm')}>

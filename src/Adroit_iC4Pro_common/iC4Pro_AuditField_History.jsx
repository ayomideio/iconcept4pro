...
<Card.Header className="font-weight-bold" style={{ backgroundColor:"#2196F3", marginTop:"0.5rem",color:"white", 
              ...
              <Col style={{marginTop:"0.5rem"}}>
                ...
                <Row className="mt-1">
                <Col  style={{marginTop:"0.5rem"}}>
                  <Form.Group as={Row} controlId="ic4proModifier">
                    <Form.Label column sm="3" className="text-center">
                      Modifier
                    </Form.Label>
                    <Col sm="9">
                  ...
                  <Col  style={{marginTop:"0.5rem"}}>
                  <Form.Group as={Row} controlId="ic4proDateModified">
                    <Form.Label column sm="3" className="text-center">
                      Date Modified
                    </Form.Label>
                    <Col sm="9">
                ...
                <Row className="mt-1">
                <Col  style={{marginTop:"0.5rem"}}>
                  <Form.Group as={Row} controlId="ic4proTimeModified">
                    <Form.Label column sm="3" className="text-center">
                      Time Modified
                    </Form.Label>
                    <Col sm="9">
                  ...
                  <Col  style={{marginTop:"0.5rem"}}>
                  <Form.Group as={Row} controlId="ic4proModifierTerminal">
                    <Form.Label column sm="3" className="text-center">
                      Modifier Terminal
                    </Form.Label>
                    <Col sm="9">
...
export default IC4ProAuditFieldHistory;

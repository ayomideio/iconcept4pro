        ...
        <div className="p-grid">
            <div className="p-col-12">
                <div className="card docs">
                    ...
                    <p>iConcept4 is an application template for React, based on the popular <a href="https://github.com/facebookincubator/create-react-app">create-react-app</a> that allows
...
`}
                    ...
                    <p>That is it, you may now start with the development of your application using the iConcept4 template.</p>
...
`}
                ...
                <h4>Structure</h4>
                <p>iConcept4 consists of 3 main parts; the application layout, layout resources and theme resources for PrimeReact components. <i>App.js</i> inside app folder is the html
...
`}
                    ...
                    <h4>Theme</h4>
				    <p>iConcept4 provides 30 PrimeReact themes out of the box. Setup of a theme is simple by including the css of theme to your
...
`}
			...
			<p>There are two possible locations for the user profile menu, first version is inline located inside the
				...
				both cases.</p>
                    ...
                    <h4>Grid CSS</h4>
                    <p>iConcept4 uses PrimeReact Flex Grid CSS throughout the demos such as Dashboard, however any Grid library can be used with it since iConcept4 Layout itself does not depend on PrimeFlex CSS.</p>

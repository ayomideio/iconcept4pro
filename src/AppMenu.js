...
const AppMenu = (props) => {
    ...
    return <AppSubmenu style={{background: "#008240", color:"#ffffff", fontWeight: "bold"}} className="layout-menu" items={props.model} menuMode={props.menuMode} menuActive={props.active} root onMenuitemClick={props.onMenuitemClick} onRootMenuitemClick={props.onRootMenuitemClick} />
}

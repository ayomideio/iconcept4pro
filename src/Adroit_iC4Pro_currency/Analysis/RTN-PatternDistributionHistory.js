...
import makeData from '../../Data/tempData/ic4pro_currencyDataHistory.json';
                ...
                columns: [
                    {
                        ...
                        aggregate: 'count',
                        Aggregated: ({ value }) => `${value} History ID`,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Rank`,
                    },
                    {
                        Header: 'Buy Rate',
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Buy Rate`,
                    },
                    {
                        Header: 'Sell Rate',
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Sell Rate`,
                    },
                    {
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Buy Rate USD Eqv`,
                    },
                    {
                        Header: 'Mid Rate',
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Mid Rate`,
                    },
                    {
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Sell Rate USD Eqv`,
                    },
                    {
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Mid Rate USD Eqv`,
                    },
                    {
                        Header: 'Rate Date',
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Rate Date`,
                    },
                    {
                        Header: 'Rate Time',
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Rate Time`,
                    },
                    {
                        Header: 'Rate Libor',
                        ...
                        filter: 'fuzzyText',
                        aggregate: 'uniqueCount',
                        Aggregated: ({ value }) => `${value} Unique Rate Libor`,
                    },
                    {
                        Header: 'Language',
                    ...
                    },
                    {
                        ...
                        aggregate: 'min',
                        Aggregated: ({ value }) => `${value} Lowest Date Modified`,
                    },
                    {

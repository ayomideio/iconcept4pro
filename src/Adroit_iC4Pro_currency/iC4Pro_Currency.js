...
import countryData from '../Data/tempData/ic4pro_currencyData.json';
import { InputText } from 'primereact/inputtext';
import DistributionTable from './Analysis/RTN-Distribution';
        ...
        <Row>
          ...
          <Col xs={8} >
            ...
            <br />
              ...
              <Col style={{ padding: '0' }}>
                <button type="submit" style={{ fontSize: "11px", background: "#6699cc", color: "white", border: 'none', borderRadius: '2px' }}>
...
export default Adroit_IC4Pro_Currency;
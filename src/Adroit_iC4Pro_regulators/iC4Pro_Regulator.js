...
const Adroit_IC4Pro_Regulator = () => {
  ...
  const [distributionNewest, setDistributionNewest] = useState(false);

  const handleDisNewClose = () => setDistributionNewest(false);
    ...
    <>
          ...
          <Col xs={8} >
            <Row >
              ...
              <Col style={{ padding: '0' }}>
                <button type="submit"
                  style={{
                    fontSize: "11px", background: "#66BB6A",
                    color: "white", border: 'none', borderRadius: '2px'
                  }}
                onClick={() => setDistributionNewest(true)}>
            ...
            <br />
              ...
              <Col style={{ padding: '0' }}>
                <button type="submit" style={{ fontSize: "11px", background: "#E63A3A", color: "white", border: 'none', borderRadius: '2px' }}
                  onClick={() => setRecordsDeleteModal(true)} disabled>
      ...
      <Dialog
        header={<span style={{
          ...
          background: 'blue',
          color: 'white'
        }}>Newest Record(s)</span>}
        visible={distributionNewest}
        onHide={handleDisNewClose}
        breakpoints={{ '960px': '75vw' }}
        style={{ width: '90vw' }}>
        <DistributionNewest />
...
export default Adroit_IC4Pro_Regulator;
...
const Wizard = () => {
    ...
    const dropdownOptions2 = [
        { label: 'Where did you hear iConcept4?', value: null },
            ...
            <div className="wizard-wrapper">
                <div className="wizard-header">
                    <div className="wizard-logo">
                        <img src="assets/layout/images/logo-black.png" alt="iConcept4-layout" style={{cursor: 'pointer'}} onClick={() => history.push('/')}/>
                    </div>
                </div>
                ...
                <div className="wizard-content">
                    <div className="wizard-card">
                        <div className="wizard-card-header">
                            <div className="wizard-card-header-banner">
                                <div className="banner-logo">
                                    <img src="assets/layout/images/extensions/iConcept4-icon.png"
                                        alt="iConcept4-layout" />
                                </div>
                                <div
                                    className={classNames("banner-image banner-1", { 'active-banner': activeTab === 'register' })}>
                                    <h1>Create a iConcept4 Account</h1>
                                    <img src="assets/layout/images/extensions/bg-header.png" alt="iConcept4-layout" />
                                </div>
                                <div
                                    className={classNames("banner-image banner-2", { 'active-banner': activeTab === 'tier' })}>
                                    <h1>Choose Your Account Type</h1>
                                    <img src="assets/layout/images/extensions/bg-header-2.png"
                                        alt="iConcept4-layout" />
                                </div>
                                <div
                                    className={classNames("banner-image banner-3", { 'active-banner': activeTab === 'payment' })}>
                            ...
                            <div className="wizard-card-tabs">
                                <div
                                    className={classNames("wizard-card-tab register-tab", { 'selected-tab': activeTab === 'register' })}
                                    onClick={() => setActiveTab('register')}>
                                    REGISTER
                                </div>
                                <div
                                    className={classNames("wizard-card-tab tier-tab", { 'selected-tab': activeTab === 'tier' })}
                                    onClick={() => setActiveTab('tier')}>
                                    CHOOSE TIER
                                </div>
                                <div
                                    className={classNames("wizard-card-tab payment-tab", { 'selected-tab': activeTab === 'payment' })}
                            ...
                            <div className="wizard-forms-wrapper p-grid p-nogutter">
                                ...
                                <div className="p-col-12 p-md-6 wizard-forms">
                                    ...
                                    <div className="calendar">
                                        ...
                                        <Calendar id="birthdate" appendTo={document.body} value={date}
                                            onChange={(e) => setDate(e.value)} />
                                    </div>

                                    <label htmlFor="iConcept4" className="form-label">Where did you hear
                                        iConcept4?</label>
                                    <Dropdown id="iConcept4" appendTo={document.body} style={{ marginBottom: '10px' }}
                        ...
                        <div
                            ...
                            <div className="wizard-button">
                                <div
                                    className={classNames('order-summary order-default', { 'selected-order': activeCard === '' })}>
                                    <p>ORDER SUMMARY</p>
                                    <h1>$00.00</h1>
                                    <span>Please select one tier.</span>
                                </div>
                                <div
                                    className={classNames('order-summary order-beginner', { 'selected-order': activeCard === 'basic' })}>
                                    <p>ORDER SUMMARY</p>
                                    <h1>$5.00</h1>
                                    <span>iConcept4 Beginner Membership.</span>
                                </div>
                                <div
                                    className={classNames('order-summary order-professional', { 'selected-order': activeCard === 'professional' })}>
                                    <p>ORDER SUMMARY</p>
                                    <h1>$10.00</h1>
                                    <span>iConcept4 Professional Membership.</span>
                                </div>
                                <div
                                    className={classNames('order-summary order-enterprise', { 'selected-order': activeCard === 'enterprise' })}>
                                    <p>ORDER SUMMARY</p>
                                    <h1>$20.00</h1>
                                    <span>iConcept4 Enterprise Membership.</span>
                                </div>

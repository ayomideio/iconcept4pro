                                ...
                                <li>
                                    ...
                                    <div className="timeline-content">
                                        <div className="child">
                                            ...
                                            <img src="assets/layout/images/dashboard/image-1.png" alt="iConcept4-layout" />
                                            <img src="assets/layout/images/dashboard/image-2.png" alt="iConcept4-layout" />
                                            <img src="assets/layout/images/dashboard/image-3.png" alt="iConcept4-layout" />
                                            <div className="timeline-footer">
                                                <i className="pi pi-clock"></i>
                                ...
                                <li>
                                    ...
                                    <div className="timeline-content">
                                        <div className="child">
                                            ...
                                            <img src="assets/layout/images/dashboard/antalya.png" alt="iConcept4-layout" style={{ width: '100%' }} />
                                            <div className="timeline-footer">
                                                <i className="pi pi-clock"></i>
                ...
                <div className="p-grid">
                    ...
                    <div className="p-col-12 p-xl-6">
                        <div className="card widget-team">
                            ...
                            <ul>
                                <li>
                                    <img src="assets/layout/images/avatar.png" alt="iConcept4-layout" />
                                ...
                                <li>
                                    <img src="assets/layout/images/avatar-john.png" alt="iConcept4-layout" />
                                    <div className="team-box">
                                ...
                                <li>
                                    <img src="assets/layout/images/avatar-julia.png" alt="iConcept4-layout" />
                                    <div className="team-box">
                                ...
                                <li>
                                    <img src="assets/layout/images/avatar-kevin.png" alt="iConcept4-layout" />
                                    <div className="team-box">
                    ...
                    <div className="p-col-12">
                        <div className="card widget-user-card">
                            <div className="user-card-header">
                                <img src="assets/layout/images/dashboard/bg-header.png" alt="iConcept4-layout" className="profile-image" />
                            </div>
            ...
            <div className="p-col-12 p-lg-4">
                <div className="card">
                    ...
                    <ul className="widget-image-list">
                        ...
                        <li>
                            <span>
                                <img src="assets/demo/images/product/bamboo-watch.jpg" alt="iConcept4-layout" />
                        ...
                        <li>
                            <span>
                                <img src="assets/demo/images/product/blue-band.jpg" alt="iConcept4-layout" />
                                <span>Blue Band</span>
                            </span>
                        ...
                        <li>
                            <span>
                                <img src="assets/demo/images/product/game-controller.jpg" alt="iConcept4-layout" />
                        ...
                        <li>
                            <span>
                                <img src="assets/demo/images/product/lime-band.jpg" alt="iConcept4-layout" />
                                <span>Lime Band</span>
                            </span>
